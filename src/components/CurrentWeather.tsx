...
import { Thermometer, Droplets, WindIcon, Eye, Info } from 'lucide-react';
...
export function CurrentWeather({ data, aiReliability }: CurrentWeatherProps) {
  return (
    <Card className="w-full max-w-md mx-auto mb-8 shadow-xl bg-card/80 backdrop-blur-sm">
      <CardHeader className="pb-2">
        <CardTitle className="text-3xl font-bold text-center">{data.locationName}</CardTitle>
      ...
      <CardContent className="flex flex-col items-center">
        ...
        <p className="text-6xl font-bold mb-2">{Math.round(data.temperature)}°C</p>
